...
public class UnenrollDialog extends Dialog {
    ...
    private void unenrollStudent() {
        ...
        try {
            ...
            if (stmt.executeUpdate() == 1) {
                status_label.setText("Student un-enrolled successfully!");
                status_label.setVisible(true);
                status_label.setTextFill(Color.GREEN);
            }
            else {
                status_label.setText("Error un-enrolling student");
                status_label.setVisible(true);
    ...
    private void loadCourses(int sID) {
        if (con != null) {
            try {
                if (!courses.isEmpty()) { courses.clear(); }
                PreparedStatement stmt = con.prepareStatement(
